...
from src.modules.data.auth import CatalogAuth
...
class CatalogAccess:
    def __init__(
        self,
        catalog_auth: CatalogAuth,
        catalog_path_builder: CatalogPathBuilder
    ) -> None:
        self._catalog_auth: CatalogAuth = catalog_auth
    ...
    def data_exists(
        ...
        with self._catalog_auth.authenticate() as spark_session:
    ...
    @property
    def catalog_auth(self) -> CatalogAuth:
        """Get the CatalogAuth instance for direct access when needed"""
        return self._catalog_auth
